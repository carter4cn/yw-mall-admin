...
replace (
	mall-activity-rpc => ../yw-mall/mall-activity-rpc
	mall-common => ../yw-mall/mall-common
	mall-logistics-rpc => ../yw-mall/mall-logistics-rpc
	...
	mall-shop-rpc => ../yw-mall/mall-shop-rpc
	mall-user-rpc => ../yw-mall/mall-user-rpc
)
